              ...
              child: Column(
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Align(
                        ...
                        child: IconButton(
                          icon: Icon(Icons.favorite_border,size: 40,color: Colors.black,),
                          onPressed: () {
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text('Food', style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),),
                      SizedBox(height: 20,),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          FlatButton.icon(
                            ...
                            icon: Icon(Icons.filter_center_focus,color: Colors.black,), 
                            label: Text(
                              'Filter',
                              style: TextStyle(
                                color: Colors.black
