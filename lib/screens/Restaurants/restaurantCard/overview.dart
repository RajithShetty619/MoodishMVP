...
class _OverViewState extends State<OverView> {
  ...
  getLatLngfromAddress(String restAddress) async {
    List<Placemark> placemark =
        await Geolocator().placemarkFromAddress(restAddress);
                      ...
                      child: Container(
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            Clipboard.setData(
                                ClipboardData(text: widget.rest.address));
                          },
            ...
            itemBuilder: (context, index) {
              return Card(
                  ...
                  child: ListTile(
                    title: Row(
                      children: <Widget>[
                        Text(widget.rest.reviews[index]["author_name"]),
                        Spacer(),
                        Text(
                            '\u{02605}${widget.rest.reviews[index]["rating"]}'),
                      ],
                    ),
                    subtitle: Text(widget.rest.reviews[index]["text"]),
                  ));
            })
      ],
    ));
