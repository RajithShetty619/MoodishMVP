...
class _DineOutState extends State<DineOut> {
  List<_Restaurants> rest = [
    _Restaurants(
        ...
        name: 'Black Olive',
        desc:
            '\u27A4 Italian, Continental, Fast Food, Health Food \n\u2691 Veera Desai, Andheri West'),
    _Restaurants(
        ...
        desc:
            '\u27A4 North Indian ,Street Food ,Pure Vegetarian ,Breakfast ,Fast Food \n\u2691 Prabhadevi, Mumbai '),
    _Restaurants(
        image: 'dominos.png',
        image1: 'dominos1.png',
        image2: 'dominos2.png',
    ...
    _Restaurants(
        ...
        name: 'Bay View',
        desc:
            '\u27A4 Chinese ,Mughlai ,North Indian ,Indian ,Tandoori ,American \n\u2691 Colaba, Mumba'),
    _Restaurants(
        image: 'pizzaah.png',
        image1: 'pizzaah1.png',
        image2: 'pizzaah.png',
    ...
    _Restaurants(
        ...
        name: 'Thambbi',
        desc:
            '\u27A4 Pure Vegetarian ,Punjabi ,South Indian ,North Indian ,Indian ,Breakfast \n\u2691 Kurla West, Mumbai '),
  ];
